...
CREATE TABLE IF NOT EXISTS `ServerCDN` (
    ...
    `Larghezza_banda` INT NOT NULL DEFAULT 0,

    `Max_capacita_trasmissione` INT NOT NULL DEFAULT 10000,
...
CREATE TABLE IF NOT EXISTS `Regionegeografica` (
    `Nome` /*INSERIRE IL TIPO APPROPRIATO*/ NOT NULL,
    PRIMARY KEY (`Nome`)
) --Engine=InnoDB;
